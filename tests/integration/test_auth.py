...
from integration import use_single_node, get_cluster
...
class BasicDseAuthTest(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        actual_jar = ADS_HOME+"target/embedded-ads-1.0-SNAPSHOT-jar-with-dependencies.jar"
        ...
        if isinstance(ccm_cluster, DseCluster):
            ...
            ccm_cluster.set_configuration_options({'authenticator': 'com.datastax.bdp.cassandra.auth.KerberosAuthenticator'})
